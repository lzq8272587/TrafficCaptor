...
//		 **************************************************************************/
//		int snaplen = 64 * 1024; // ץȡ������ֽڳ��ȣ�65535 Capture all packets, no trucation
//		int flags = Pcap.MODE_PROMISCUOUS; // ץȡ����packet capture all packets
...
//
////				System.out
////						.printf("Received packet at %s caplen=%-4d len=%-4d %s\n",
...
////						);
//				Udp udp=new Udp();
//				//if(packet.hasHeader(udp)&&(udp.source()==53||udp.destination()==53))
//				{
